    ...
    <?php
        ...
        if (isset($_GET['search'])) {
          if (empty($_GET['search'])) {
            ...
            $query = mysqli_query($conn, "select * from artikel where judul LIKE '%".$_GET['search']."%' LIMIT $mulai, $halaman");
            $sql = mysqli_query($conn, "select * from artikel");
          }
        }
        else {
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                  <?php
                                      ...
                                      for ($i=1; $i<=$pages ; $i++){
                                        if (isset($_GET['search'])) {
                                          $url = "artikel.php?search=".$_GET['search']."&page=$i";
                                        } else {
                                          $url = "artikel.php?page=$i";
                                        }
                                  ?>

    ...
    <section class="content">
	  ...
	  <div class="row">
        ...
        <div class="col-xl-4 col-md-6 col-12">
          	<div class="box box-body">
              <h6 class="mb-0">
                <span class="text-uppercase">JUMLAH ARTIKEL</span>
                <span class="float-right"><a class="btn btn-xs btn-primary" href="#">View</a></span>
              </h6>
              <br>
			  <small>Monthly Deduction</small>
              <p class="font-size-26">4</p>
        ...
        <div class="col-xl-4 col-md-6 col-12">
          	<div class="box box-body">
              <h6 class="mb-0">
                <span class="text-uppercase">JUMLAH FOTO</span>
                <span class="float-right"><a class="btn btn-xs btn-primary" href="#">View</a></span>
              </h6>
              <br>
			  <small>Weekly Revenue</small>
              <p class="font-size-26">5</p>
               ...
               <div class="box-body">
                 ...
                 <div class="col-12">
                   ...
                   <div class="form-group">
       							...
       							<div class="controls">
       								<input type="text" name="noChar" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="Hanya Nomer Saja"> </div>
       						</div>

                  <div class="form-group">
      							<h5>Alamat Toko <span class="text-danger">*</span></h5>
      							<div class="controls">
      								<textarea name="textarea" id="textarea" class="form-control" required placeholder=""></textarea>
      							</div>
      						</div>
                  ...
                  <div class="text-xs-right">
        						<button type="submit" class="fcbtn btn btn-info btn-outline btn-1e">Update Data Toko</button>
        					</div>
        <!-- End Basic Form -->
	</section>
    <!-- /.content -->

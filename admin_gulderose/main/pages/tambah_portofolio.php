    ...
    <div class="content-header">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
              ...
              <li class="breadcrumb-item active" aria-current="page">Tambah Galeri Portofolio</li>
						</ol>
					</nav>
				</div>
			</div>
      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">TAMBAH GALERI PORTOFOLIO</h4>
               ...
               <div class="row">
                 <div class="col">
                     ...
                     <div class="row">
                       <div class="col-12">
                         ...
                         <div class="text-xs-right" >
                          <input type="submit" name="tambah_foto" class="btn btn-info btn-outline btn-1e" value="Tambah Foto">
                         </div>
                   ...
                   <?php
                    ...
                    $sql = "INSERT INTO galeri(judul, foto,id_kategori) VALUES('$judul','$foto','$kategori')";
                      ...
                      if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target)) {
                        ...
                        ?>
                          <script type="text/javascript">
                            ...
                            document.location='tambah_portofolio.php';
                          </script>
                        <?php
         							}
                    }

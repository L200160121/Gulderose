      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">TAMBAH DATA PENGGUNA</h4>
                       ...
                       <div class="row">
                         <div class="col-12">
                           ...
                           <div class="form-group">
                             ...
                             <div class="controls">
                               <input type="password" name="password_user" class="form-control" required data-validation-required-message="This field is required"> </div>
                           </div>
                           <div class="form-group">
                             <h5>Nama Pengguna<span class="text-danger">*</span></h5>
                             <div class="controls">
                               <input type="text" name="nama_user" class="form-control" required data-validation-required-message="This field is required"> </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <select class="form-control p-0" id="input6" required name='status_user'>
                                 ...
                                 <!-- <option value="Admin">Wall Decor</option> -->
                             </select><span class="highlight"></span> <span class="bar"></span> <br>
                           </div>

                           <div class="text-xs-right">
                              <input type="submit" name="tambah_user" class="btn btn-info btn-outline btn-1e" value="Tambah Data Pengguna">
                           </div>
                         </div>
                       </div>
                       </form>
          ...
          <?php
                 ...
                 $nama = $_GET['nama_user'];
                 $status = $_GET['status_user'];
                 $submit = $_GET['tambah_user'];

                 if ($submit) {
                   if ($username && $password !='') {
                     if ($username && $nama !='') {
                       if ($password && $nama !='') {
                         $sql = "INSERT INTO user(username,password,nama,status) VALUES ('$username', '$password', '$nama', '$status')";
                         // $sql = "insert into pesan (id_pesan,nama,email,no_hp,subjek,pesan) values ('$id_pesan','$nama','$email','$no_hp','$subjek','$pesan')";
                           ...
                           if ($run){
                            ...
                            ?>
                              <script type="text/javascript">
                                alert('Data Pengguna Admin Harus Diisi Lengkap');

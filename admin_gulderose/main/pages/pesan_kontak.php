			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">PESAN KONTAK</h4>
						<h6 class="box-subtitle">Informasi mengenai data pesan kontak Gulderose.co</h6>
					</div>
					<div class="box-body">
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          ...
                          <td>$data[pesan]</td>
                          <td>
                              <a href='delete_pesan.php?del=$data[id_pesan]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

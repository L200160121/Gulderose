			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">DATA ARTIKEL</h4>
						<h6 class="box-subtitle">Informasi mengenai data artikel Gulderose.co</h6>
					</div>
          <div class="text-xs-right" align='center'> <br>
          <a href="tambah_artikel.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value="Tambah Artikel"></a>
          </div>
					<div class="box-body">
                  ...
                  include "../../../.private/koneksi.php";
                  $no = 1;
                  $sql = "select * from artikel,kategori where artikel.id_kategori=kategori.id_kategori order by id_artikel desc ";
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          <td>$no</td>
                          <td>$data[judul]</td>
                          <td><img src='../../images/gallery/artikel/$data[foto]' width='150' height='100'></td>
                          ...
                          <td>
                              <a href='update_artikel.php?upd=$data[id_artikel]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_artikel.php?del=$data[id_artikel]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

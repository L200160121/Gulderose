                     ...
                     <div class="row">
                       <div class="col-12">
                         <div class="form-group">
                           ...
                           <div class="controls">
                             <input type="text" name="namakatalog" class="form-control" required> </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="text-xs-right">
                          <input type="submit" name="submit" class="btn btn-info btn-outline btn-1e" value="Tambah Data Katalog">
                         </div>
                     </form>
                 ...
                 <?php
                  ...
                  if($submit){
                    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target)){
                      ...
                      $sql = "INSERT INTO katalog VALUES('', '$nama','$harga','$foto','$waktu')";
                      if (mysqli_query($conn,$sql)) {
                        ...
                        $cekkatalog   = "SELECT id_katalog FROM katalog WHERE waktu_post = '$waktu'";
                        ...
                        ?>
                          <script type="text/javascript">
                            alert('Berhasil menambah data katalog');
                        ...
                        ?>
                        <script type="text/javascript">
                          alert('Gagal menambah data katalog');
                        </script>
                        <?php
                      }
                    }

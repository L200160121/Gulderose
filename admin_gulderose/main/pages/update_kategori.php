    ...
    <div class="content-header">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
              ...
              <li class="breadcrumb-item active" aria-current="page">Update Data Kategori</li>
						</ol>
					</nav>
				</div>
			</div>
      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">UPDATE DATA KATEGORI</h4>
           <h6 class="box-subtitle">Informasi mengenai data kategori website Gulderose.co</h6>
         </div>
         ...
         <?php
           ...
           $upd = $_GET['upd'];
           $sql = "select *from kategori where id_kategori='$upd' ";
                   ...
                   <!-- <form novalidate> -->
                      <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" name="form">
                       <div class="row">
                         <div class="col-12">
                           <div class="form-group">
                             ...
                             <div class="controls">
                               <input type="text" name="nama_kategori" value="<?php echo $data['nama_kategori'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                           </div>
                           <div class="text-xs-right">
                              <input type="submit" name="update_kategori" class="btn btn-info btn-outline btn-1e" value="Update Data Kategori">
                           </div>
                         </div>
                       </div>
                       </form>
                       ...
                       <!-- UPDATE DATA KATEGORI -->
                        ...
                        $submit = $_POST['update_kategori'];

                        if ($submit) {
                           $sql = "update kategori set nama_kategori='$nama_kategori' where id_kategori='$upd' ";

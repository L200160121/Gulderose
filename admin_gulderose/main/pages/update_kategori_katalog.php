             ...
             <div class="box-body">
               <div class="row">
                 <div class="col">
                   ...
                   <?php
                    $upd = $_GET['upd'];
                    $data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM kategorikatalog WHERE id_kategorikatalog = '$upd'"))
                    ?>
                      <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" name="form" enctype="multipart/form-data">
                       <div class="row">
                         <div class="col-12">
                           <div class="form-group">
                             ...
                             <div class="controls">
                               <input type="text" name="nama_kategori" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $data['nama_kategori']?>"> </div>
                           </div>
                           <div class="form-group">
                             <h5>Tipe Kategori<span class="text-danger">*</span></h5>
                             <select class="form-control p-0" id="input6" required name='tipe_kategori'>
                               <option value="Jenis" <?php if($data['tipe_kategori']=='Jenis'){echo "selected";} ?>>Jenis</option>
                               <option value="Warna" <?php if($data['tipe_kategori']=='Warna'){echo "selected";} ?>>Warna</option>
                               <option value="Acara" <?php if($data['tipe_kategori']=='Acara'){echo "selected";} ?>>Acara</option>
                             </select><span class="highlight"></span> <span class="bar"></span> <br>
                           </div>
                           <div class="text-xs-right">
                              <input type="submit" name="submit" class="btn btn-info btn-outline btn-1e" value="Update Kategori Katalog">
                           </div>
                         </div>
                       </div>
                       </form>
                       ...
                       <?php
                          ...
                          $submit = $_POST['submit'];
                          $sql = "UPDATE kategorikatalog SET nama_kategori='$nama_kategori', tipe_kategori='$tipe_kategori' WHERE id_kategorikatalog='$upd'";
                          if ($submit) {

			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						...
						<h6 class="box-subtitle">Informasi mengenai data pengguna Gulderose.co</h6>
					</div>
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_pengguna.php"> <input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value="Tambah Pengguna"></a>
          </div>
					<div class="box-body">
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          ...
                          <td>
                              <a href='update_pengguna.php?upd=$data[username]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_pengguna.php?del=$data[username]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Update Data Artikel</li>
						</ol>
					</nav>
				</div>
			</div>
        ...
        <div class="col-12">
          ...
          <div class="box">
            <div class="box-header with-border" align='center'>
  						<h4 class="box-title">UPDATE DATA ARTIKEL</h4>
  						<h6 class="box-subtitle">Informasi mengenai data Artikel Website Gulderose.co</h6>
  					<!-- </div> -->
            ...
            <div class="box-body">
              ...
              <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST" name="form" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="judul_artikel" value="<?php echo $data['judul'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                </div>
                <div class="form-group">
                  <h5>Foto Artikel<span class="text-danger">*</span></h5>
                  <img src="../../images/gallery/artikel/<?php echo $data['foto']; ?>" width='220'>
                  <div class="controls">
                    <input type="file" name="foto_artikel" class="form-control" required><?php echo $data['foto']; ?> </div>
                    <div class="form-control-feedback"><small>Untuk Foto Artikel Website</small></div>
                </div>
                <div class="form-group">
    							<h5>Ringkasan Artikel<span class="text-danger">*</span></h5>
    							<div class="controls">
    								<textarea name="ringkasan_artikel"  id="textarea" class="form-control" required placeholder=""><?php echo $data['ringkasan'];?></textarea>
    							</div>
    						</div>
                <div ="form-group">
                    <h5>Isi Artikel<span class="text-danger">*</span></h5>
                    <textarea id="editor1" name="isi_artikel"  rows="10" cols="80"><?php echo $data['isi'];?></textarea>
                </div>
                <br>
                <div class="form-group">
                  <h5>Kategori Artikel<span class="text-danger">*</span></h5>
                  <select class="form-control p-0" id="input6" required name='kategori'>
                    ...
                    <?php
                       ...
                       while($hasil = mysqli_fetch_array($run)){
                         if($hasil[id_kategori]==$data[id_kategori]){
                           echo "<option value='$hasil[id_kategori]' selected='selected'>$hasil[nama_kategori]</option>";
                         }
                         else{
                ...
                <div class="text-xs-right">
                 <input type="submit" name="update_artikel" class="btn btn-info btn-outline btn-1e" value="Update Data Artikel">
                </div>
              </form>

              <!-- UPDATE DATA GALERI PORTOFOLIO -->
              <?php
                // error_reporting(E_ALL ^ E_NOTICE^E_DEPRECATED);
               // include "../../../.private/koneksi.php";
                $target = "../../images/gallery/artikel/".basename($_FILES['foto_artikel']['name']);

                $foto = $_FILES['foto_artikel']['name'];
                $judul = $_POST['judul_artikel'];
                $ringkasan = $_POST['ringkasan_artikel'];
                $isi = $_POST['isi_artikel'];
                $kategori = $_POST['kategori'];
               // $tambah

               $sql = "update artikel set judul='$judul', foto='$foto', ringkasan='$ringkasan', isi='$isi', id_kategori='$kategori' where id_artikel='$upd' ";

                if(isset($_POST["update_artikel"])){
                  if (move_uploaded_file($_FILES["foto_artikel"]["tmp_name"], $target)) {
                   ...
                   ?>
                     <script type="text/javascript">
                       ...
                       document.location='update_artikel.php';
                     </script>
                   <?php
                  }
                }

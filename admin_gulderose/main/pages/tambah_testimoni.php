               ...
               <div class="row">
                     ...
                     <div class="row">
                       <div class="col-12">
                         ...
                         <div class="form-group">
             							...
             							<div class="controls">
             								<textarea name="isi" id="textarea" class="form-control" required placeholder=""></textarea>
             							</div>
             						</div>
                         <div class="text-xs-right" >
                          <input type="submit" name="tambah_testimoni" class="btn btn-info btn-outline btn-1e" value="Tambah Data Testimoni">
                         </div>
                       </div>
                     </div>
                     </form>
                 ...
                 <?php
                  ...
                  // $tambah
       						...
       						$sql = "INSERT INTO `testimoni`(`foto`, `nama`, `posisi`, `isi`) VALUES ('$foto','$nama','$posisi','$isi')";
                          ...
                          <script type="text/javascript">
                            alert('Data Testimoni Berhasil Ditambahkan');
                      ...
                      ?>
                        <script type="text/javascript">
                          ...
                          document.location='tambah_testimoni.php';
                        </script>
                      <?php
       							}
       						}

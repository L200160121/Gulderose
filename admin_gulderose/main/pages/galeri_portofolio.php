				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Galeri Portofolio</li>
						</ol>
					</nav>
				</div>
			</div>
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">GALERI FOTO PORTOFOLIO</h4>
						<h6 class="box-subtitle">Informasi mengenai data galeri portofolio Gulderose.co</h6>
					</div>
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_portofolio.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value="Tambah Foto Galeri Portofolio"></a>
          </div>
					<div class="box-body">
							...
							<table id="example" class="table mt-0 table-hover no-wrap table-striped table-bordered" data-page-size="10">
								<thead>
									<tr align='center'>
										<th><b>Nomor</b></th>
										<th><b>Judul</b></th>
										<th><b>Foto Portofolio</b></th>
										<th><b>Kategori</b></th>
										<th><b>waktu_upload</b></th>
										<th><b>Aksi</b></th>
									</tr>
								</thead>
								<tbody>
                  <!-- VIEW GALERI PORTFOLIO -->
                  <?php
                  // error_reporting(E_ALL ^ E_NOTICE ^ E_DEPRECATED);
                  // include "../../../.private/koneksi.php";
                  $no = 1;
                  $sql = "select * from galeri,kategori where galeri.id_kategori=kategori.id_kategori order by id_galeri desc ";
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          <td>$no</td>
                          <td>$data[judul]</td>
                          <td><img src='../../images/gallery/portofolio/$data[foto]' width='125' height='100'></td>
                          <td>$data[nama_kategori]</td>
                          <td>$data[tanggal]</td>
                          <td>
                              <a href='update_galeri_portofolio.php?upd=$data[id_galeri]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_galeri_portofolio.php?del=$data[id_galeri]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

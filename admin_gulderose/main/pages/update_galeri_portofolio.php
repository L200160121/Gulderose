...
<head>
  ...
  <meta charset="utf-8">
   ...
   function confirmData() {
   	if (confirm("Data Galeri Sudah Benar?")) {
   		return true;
   	}else {
   		return false;
   	}
				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item" aria-current="page">Galeri Portofolio</li>
              <li class="breadcrumb-item active" aria-current="page">Update Galeri Portofolio</li>
						</ol>
					</nav>
				</div>
			</div>
      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">UPDATE GALERI PORTOFOLIO</h4>
           <h6 class="box-subtitle">Informasi mengenai Foto Galeri Portofolio website Gulderose.co</h6>
         </div>
             ...
             <div class="box-body">
               <div class="row">
                 <div class="col">
                   ...
                   <?php
                     $upd = $_GET['upd'];
                     $sql = "select *from galeri where id_galeri='$upd' ";
                     ...
                     <div class="row">
                       <div class="col-12">
                         <div class="form-group">
                           ...
                           <div class="controls">
                             <input type="text" name="judul" value="<?php echo $data['judul'];?>" class="form-control" required> </div>
                             <!-- <div class="form-control-feedback"><small>Untuk Slider Home Website</small></div> -->
                         </div>
                         <div class="form-group">
                           <h5>Foto Galeri Portofolio<span class="text-danger">*</span></h5>
                           <img src="../../images/gallery/portofolio/<?php echo $data['foto']; ?>" width='220'>
                           <div class="controls">
                             <input type="file" name="foto" class="form-control" required data-validation-required-message="This field is required"> <?php echo $data['foto']; ?></div>
                         </div>
                         <div class="form-group">
                           <h5>Kategori Galeri Portofolio<span class="text-danger">*</span></h5>
                         ...
                         <div class="text-xs-right" >
                          <input type="submit" name="update_galeri" class="btn btn-info btn-outline btn-1e" value="Update Data Foto" >
                         </div>
                       </div>
                     </div>
                   </form>
                   ...
                   <?php
                    ...
                    // include "../../../.private/koneksi.php";
                     $target = "../../images/gallery/portofolio/".basename($_FILES['foto']['name']);
                    ...
                    $sql = "update galeri set judul='$judul', foto='$foto', id_kategori='$kategori' where id_galeri='$upd' ";
                       ...
                       if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target)) {
                        ...
                        ?>
                          <script type="text/javascript">
                            ...
                            document.location='update_galeri_portofolio.php';
                          </script>
                        <?php
                       }
                     }

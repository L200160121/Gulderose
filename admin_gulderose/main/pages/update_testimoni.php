      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">TAMBAH TESTIMONI WEBSITE</h4>
           <h6 class="box-subtitle">Informasi mengenai testimoni website Gulderose.co</h6>
         </div>
             <!-- /.box-header -->
             <div class="box-body">
               <?php
                 ...
                 $upd = $_GET['upd'];
                 $sql = "select *from testimoni where id_testimoni='$upd' ";
               ...
               <div class="row">
                     ...
                     <div class="row">
                       <div class="col-12">
                         <div class="form-group">
                           <h5>Foto Testimoni<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <img src="../../images/testimoni/<?php echo $data['foto']; ?>" width='220'>
                             <input type="file" name="foto" class="form-control" required><?php echo $data['foto']; ?> </div>
                             <div class="form-control-feedback"><small>Untuk Foto Testimoni Website</small></div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <div class="controls">
                             <input type="text" name="posisi" value="<?php echo $data['posisi'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>
                         <div class="form-group">
             							<h5>Isi Testimoni<span class="text-danger">*</span></h5>
             							<div class="controls">
             								<textarea name="isi" id="textarea" value="" class="form-control" required placeholder=""><?php echo $data['isi'];?></textarea>
             							</div>
             						</div>
                         <div class="text-xs-right" >
                          <input type="submit" name="update_testimoni" class="btn btn-info btn-outline btn-1e" value="Update Data Testimoni">
                         </div>
                       </div>
                     </div>
                     </form>
                 ...
                 <?php
                  ...
                  // include "../../../.private/koneksi.php";
       						$target = "../../images/testimoni/".basename($_FILES['foto']['name']);
                  ...
                  // $tambah
       						...
       						$sql = "update testimoni set foto='$foto', nama='$nama', posisi='$posisi', isi='$isi' where id_testimoni='$upd' ";
                      ...
                      ?>
                        <script type="text/javascript">
                          ...
                          document.location='update_testimoni.php';
                        </script>
                      <?php
       							}
       						}

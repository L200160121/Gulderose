				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Data Katalog</li>
						</ol>
					</nav>
				</div>
			</div>
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">DATA KATALOG PRODUK</h4>
						<h6 class="box-subtitle">Informasi mengenai data produk Gulderose.co</h6>
					</div>
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_katalog.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value='Tambah Katalog'></a>
          </div>
					<div class="box-body">
                    ...
                    <th><b>Harga</b></th>
								...
								<tbody>
									<?php
                  $no = 1;
                  $sql = "select * from kategorikatalog_has_katalog, kategorikatalog, katalog where kategorikatalog.id_kategorikatalog = kategorikatalog_has_katalog.id_kategorikatalog and katalog.id_katalog = kategorikatalog_has_katalog.id_katalog group by katalog.id_katalog";
                  $query = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($query)) {
                      $sql1 = "select kategorikatalog_has_katalog.id_katalog, kategorikatalog.nama_kategori from kategorikatalog_has_katalog, kategorikatalog, katalog where kategorikatalog.id_kategorikatalog = kategorikatalog_has_katalog.id_kategorikatalog and katalog.id_katalog = kategorikatalog_has_katalog.id_katalog and katalog.id_katalog = $data[id_katalog]";
                      ...
                      while ($data1 = mysqli_fetch_array($query1)){
                        if($data['katalog.id_katalog'] == $data1['kategorikatalog_has_katalog.id_katalog']){
                        echo "$data1[nama_kategori], ";}
                      }
                      echo"</td>
                          <td><img src='../../images/katalog/$data[foto]' width='125' height='100'></td>
                          <td>$data[harga]</td>
                          <td>$data[waktu_post]</td>
                          <td>
                              <a href='update_katalog.php?upd=$data[id_katalog]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_katalog.php?del=$data[id_katalog]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

...
<head>
  ...
  function confirmDelete() {
  	if (confirm("Hapus Data Testimoni?")) {
  		return true;
  	}else {
  		return false;
  	}
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">DATA TESTIMONI</h4>
						<h6 class="box-subtitle">Informasi mengenai data testimoni Gulderose.co</h6>
					</div>
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_testimoni.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value="Tambah Data Testimoni"></a>
          </div>
					<div class="box-body">
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          <td>$no</td>
                          <td><img src='../../images/testimoni/$data[foto]' width='125' height='100'></td>
                          <td>$data[nama]</td>
                          <td>$data[posisi]</td>
                          <td>$data[isi]</td>
                          <td>$data[waktu_post]</td>
                          <td>
                              <a href='update_testimoni.php?upd=$data[id_testimoni]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_testimoni.php?del=$data[id_testimoni]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

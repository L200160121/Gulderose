				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item" aria-current="page">Slider Home</li>
              <li class="breadcrumb-item active" aria-current="page">Tambah Foto Slider</li>
						</ol>
					</nav>
				</div>
			</div>
      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">TAMBAH FOTO SLIDER WEBSITE</h4>
           <h6 class="box-subtitle">Informasi mengenai Foto Slider website Gulderose.co</h6>
         </div>
             <!-- /.box-header -->
             <div class="box-body">
               <div class="row">
                 <div class="col">
                   <form novalidate action="<?php $_SERVER['PHP_SELF'];?>" method="POST" name="form" enctype="multipart/form-data">
                     <div class="row">
                       <div class="col-12">
                         <div class="form-group">
                           <h5>Foto Slider<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="file" name="foto_slider" class="form-control" required> </div>
                             <div class="form-control-feedback"><small>Untuk Slider Home Website</small></div>
                         </div>
                         <div class="form-group">
                           <h5>Judul Slider<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="text" name="judul_slider" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>
                         <div class="form-group">
                           <h5>Keterangan Foto<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="text" name="keterangan_slider" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>
                         <div class="text-xs-right" >
                          <input type="submit" name="tambahslider" class="btn btn-info btn-outline btn-1e" value="Tambah Foto">
                         </div>
                       </div>
                     </div>
                     </form>
                 ...
                 <?php
                  ...
                  // include "../../../.private/koneksi.php";
       						$target = "../../images/slider/".basename($_FILES['foto_slider']['name']);

       						$foto = $_FILES['foto_slider']['name'];
                  $judul = $_POST['judul_slider'];
       						$keterangan = $_POST['keterangan_slider'];
                  // $tambah

       						$sql = "INSERT INTO slider(foto_slider,judul_slider, keterangan_slider) VALUES('$foto','$judul','$keterangan')";

       						if(isset($_POST["tambahslider"])){
       							if (move_uploaded_file($_FILES["foto_slider"]["tmp_name"], $target)) {
                      ...
                      ?>
                        <script type="text/javascript">
                          ...
                          document.location='tambah_slider.php';
                        </script>
                      <?php
       							}
       						}

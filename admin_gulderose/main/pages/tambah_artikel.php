            ...
            <div class="box-body">
              <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST" name="form" enctype="multipart/form-data" >
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="judul_artikel" class="form-control" required data-validation-required-message="This field is required"> </div>
                </div>
                <div class="form-group">
                  <h5>Foto Artikel<span class="text-danger">*</span></h5>
                  <div class="controls">
                    <input type="file" name="foto_artikel" class="form-control" required> </div>
                ...
                <div class="form-group">
    							...
    							<div class="controls">
    								<textarea name="ringkasan_artikel" id="textarea" class="form-control" required placeholder=""></textarea>
    							</div>
    						</div>
                <div ="form-group">
                ...
                <div class="text-xs-right">
                 <input type="submit" name="tambah_artikel" class="btn btn-info btn-outline btn-1e" value="Tambah Artikel">
                </div>
              </form>
               ...
               <?php
                 ...
                 // $keterangan = $_POST['keterangan_slider'];
                  ...
                  $sql = "INSERT INTO `artikel` (`judul`, `ringkasan`, `isi`, `foto`, `id_kategori`, `penulis`) VALUES ('$judul','$ringkasan','$isi','$foto','$kategori','$penulis')";
                  // echo $sql;

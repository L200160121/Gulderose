    ...
    <div class="content-header">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
              ...
              <li class="breadcrumb-item active" aria-current="page">Updata Data Pengguna</li>
						</ol>
					</nav>
				</div>
			</div>
      ...
      <!-- Basic Forms -->
       <div class="box">
         <div class="box-header with-border" align='center'>
           <h4 class="box-title">UPDATE DATA PENGGUNA</h4>
           <h6 class="box-subtitle">Informasi mengenai Data Pengguna Admin website Gulderose.co</h6>
         </div>

         <?php
           // include "../../../.private/koneksi.php";
           $upd = $_GET['upd'];
           $sql = "select *from user where username='$upd' ";
          ...
          ?>
             ...
             <div class="box-body">
               <div class="row">
                 <div class="col">
                   <form novalidate action="<?php $_SERVER['PHP_SELF'];?>" method="post" name="form">
                     <div class="row">
                       <div class="col-12">
                         <div class="form-group">
                           <h5>Username<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="text" name="username" value="<?php echo $data['username'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>
                         <div class="form-group">
                            <h5>Password<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="password" name="password_user" value="<?php echo $data['password'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>
                         <div class="form-group">
                           <h5>Nama Pengguna<span class="text-danger">*</span></h5>
                           <div class="controls">
                             <input type="text" name="nama_user" value="<?php echo $data['nama'];?>" class="form-control" required data-validation-required-message="This field is required"> </div>
                         </div>

                         <div class="form-group">
                           <h5>Status Pengguna<span class="text-danger">*</span></h5>
                           <select class="form-control p-0" id="input6" required name='status_user'>
                               <option value="Admin"
                         ...
                         <div class="text-xs-right" >
                            <input type="submit" name="tambah_user" class="btn btn-info btn-outline btn-1e" value="Update Data Pengguna">
                         </div>
                       </div>
                     </div>
                     <!-- /.content-wrapper -->
          ...
          <!-- UPDATE DATA PENGGUNA -->
           ...
           $submit = $_POST['tambah_user'];

           if ($submit) {
              $sql = "update user set username='$username', password='$password', nama='$nama', status='$status'
                        where username='$upd' ";
               ...
               if ($query) {
                   ...
                   <script>alert("Data Berhasil Diubah");
                       document.location = 'pengguna.php'</script>
                   <?php
               }

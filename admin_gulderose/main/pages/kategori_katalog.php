...
<head>
  ...
  function confirmDelete() {
  	if (confirm("Hapus Data Kategori Katalog?")) {
  		return true;
  	}else {
  		return false;
  	}
				...
				<div class="d-inline-block align-items-center">
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Kategori Katalog</li>
						</ol>
					</nav>
				</div>
			</div>
    ...
    <section class="content">
      ...
      <div class="row">
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">KATEGORI KATALOG</h4>
          ...
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_kategori_katalog.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value='Tambah Kategori Katalog'></a>
          </div>
					<div class="box-body">
                  ...
                  <?php
                  $no = 1;
                  $sql = "select * from kategorikatalog";
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          ...
                          <td>
                              <a href='update_kategori_katalog.php?upd=$data[id_kategorikatalog]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_kategori_katalog.php?del=$data[id_kategorikatalog]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

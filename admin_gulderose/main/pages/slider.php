			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border" align='center'>
						<h4 class="box-title">FOTO SLIDER WEBSITE</h4>
						<h6 class="box-subtitle">Informasi mengenai foto slider website Gulderose.co</h6>
					</div>
          <div class="text-xs-right"> <br>
            <center><a href="tambah_slider.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1e" value="Tambah Foto"></a></center>
          </div>
					<div class="box-body">
						<div class="table-responsive">
							<table id="example" class="table mt-0 table-hover no-wrap table-striped table-bordered" data-page-size="10">
								<thead>
									<tr align='center'>
										<th><b>Nomor</b></th>
										<th><b>Foto Slider</b></th>
										<th><b>Judul</b></th>
                    <th><b>Keterangan</b></th>
                    <th><b>Waktu Upload</b></th>
										<th><b>Aksi</b></th>
									</tr>
								</thead>
								<tbody>
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          <td>$no</td>
                          <td><img src='../../images/slider/$data[foto_slider]' width='180' height='100'></td>
                          <td>$data[judul_slider]</td>
                          <td>$data[keterangan_slider]</td>
                          <td>$data[waktu_upload]</td>

                          <td>
                              <a href='delete_slider.php?del=$data[id_slider]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>

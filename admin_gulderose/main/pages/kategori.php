    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="text-xs-right" align='center'> <br>
            <a href="tambah_kategori.php"><input type="submit" class="fcbtn btn btn-info btn-outline btn-1" value='Tambah Kategori'></a>
          </div>
					<div class="box-body">
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                      ...
                      <tr align='center'>
                          ...
                          <td>
                              <a href='update_kategori.php?upd=$data[id_kategori]'><input type='submit' value='Edit' class='fcbtn btn btn-info btn-outline btn-1e' ></a>
                              <a href='delete_kategori.php?del=$data[id_kategori]' onClick='return confirmDelete()'><input type='submit' value='Hapus' class='fcbtn btn btn-danger btn-outline btn-1e' ></a>
                          </td>
